...
export default function Footers() {
  return (
    <div>
      <footer className="bg-[#eb521ec7] py-10">
      {/* Upper Footer */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="mt-4">
                <img
                  ...
                  className="w-24"
                />
                <p className="text-[#ffffff9c] mt-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="/shop/left_sidebar" className="text-[#ffffff75] hover:text-gray-900">Womens</a></li>
                <li><a href="/shop/left_sidebar" className="text-[#ffffff94] hover:text-gray-900">Clothing</a></li>
                <li><a href="/shop/left_sidebar" className="text-[#ffffff88] hover:text-gray-900">Accessories</a></li>
                <li><a href="/shop/left_sidebar" className="text-[#ffffff94] hover:text-gray-900">Featured</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="#" className="text-[#ffffff75] hover:text-gray-900">Shipping & Return</a></li>
                <li><a href="#" className="text-[#ffffff75] hover:text-gray-900">Secure Shopping</a></li>
                <li><a href="#" className="text-[#ffffff75] hover:text-gray-900">Gallery</a></li>
                <li><a href="#" className="text-[#ffffff75] hover:text-gray-900">Affiliates</a></li>
                <li><a href="#" className="text-[#ffffff75] hover:text-gray-900">Contacts</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-[#ffffff75]">
