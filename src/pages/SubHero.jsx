        ...
        <div className="flex  gap-5">
          ...
          <div className="w-full md:w-1/2">
            <a href="/">
              <div className="collection-banner relative group">
                <img
                  src="/image/sub-banner1.5d5f9c6f.jpg"
                ...
                <div className="contain-banner absolute inset-0 flex items-center justify-end p-5  to-transparent rounded-lg">
                  <div className="text-right">
                    ...
                    <h2 className="text-5xl md:text-7xl font-bold uppercase text-black">Men</h2>
                  </div>
                </div>
              </div>
            </a>
          ...
          <div className="w-full md:w-1/2">
            <a href="/left-sidebar/collection">
              <div className="collection-banner relative group">
                <img
                  src="/image/sub-banner2.3b2448f3.jpg"
                ...
                <div className="contain-banner absolute inset-0 flex items-center justify-end p-5  to-transparent rounded-lg">
                  <div className="text-right">
                    <h4 className="text-2xl md:text-4xl text-red-600">10% off</h4>
                    <h2 className="text-5xl md:text-7xl font-bold uppercase text-black">Women</h2>
                  </div>
                </div>
              </div>
            </a>
